...
Welcome to ``sec_filings_api`` contributor's guide.
...
If you experience bugs or general issues with ``sec_filings_api``, please have a look
...
You can help improve ``sec_filings_api`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``sec_filings_api`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``sec_filings_api``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/sec_filings_api.git
    cd sec_filings_api
...
#. Install |pre-commit|_::
   ...
   ``sec_filings_api`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/sec_filings_api
.. _issue tracker: https://github.com/<USERNAME>/sec_filings_api/issues
.. <-- end -->

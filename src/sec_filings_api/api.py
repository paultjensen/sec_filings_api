...
__author__ = "paul.t.jensen"
__copyright__ = "paul.t.jensen"
__license__ = "MIT"
...
# `from sec_filings_api.skeleton import fib`,
...
def parse_args(args):
    ...
    parser.add_argument(
        "--version",
        action="version",
        version="sec_filings_api {ver}".format(ver=__version__),
    )
    parser.add_argument(
        "-v",
        "--verbose",
...
def main(args):
    """Wrapper allowing :func:`call_api` to be called with string arguments in a CLI fashion
    Args:
      args (List[str]): command line parameters as list of strings
...
if __name__ == "__main__":
    ...
    #
    #     python -m sec_filings_api.skeleton 42
    #
    run()
